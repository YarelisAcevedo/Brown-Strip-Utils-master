...
parser.add_argument('-i', '--input', nargs='+', default='strips', help='Name of input file. Can take single file, folder, or regular expressions.')
...
def main():
    ...
    for folder in inStr:
        ...
        print('Found the following files:', all_files)
        if all_files == []:
